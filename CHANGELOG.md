...
## [0.2.0](https://github.com/bbsakura/xk6-diameter/compare/v0.1.1...v0.2.0) (2026-09-07)


### Features

* add Receive/Subscribe/Serve for incoming messages ([a87aaf9](https://github.com/bbsakura/xk6-diameter/commit/a87aaf9421187ca9c45102b2597b208673a5aff4))
* add smoke test ([ddcf5fe](https://github.com/bbsakura/xk6-diameter/commit/ddcf5feb5bb9b2652bf5c14a02315fe55d199898))
* HBH-ID correlation + generic Cmd/AVP via diam.Dict ([3665a1b](https://github.com/bbsakura/xk6-diameter/commit/3665a1b65947e64d435c536679c5611421e57ba9))
* matcher cmd_code accepts string ([88e1fe9](https://github.com/bbsakura/xk6-diameter/commit/88e1fe971c924d6064f4b4c7986c249477d56525))
* single-delivery for subscribe/serve (no fan-out) ([3e10efe](https://github.com/bbsakura/xk6-diameter/commit/3e10efe9037da0e21af83bd05e8c9538770d90aa))
* split Client/ClientHdr with per-VU latency metric ([ba6e4c0](https://github.com/bbsakura/xk6-diameter/commit/ba6e4c07b144654d0541aa78944003d544808936))
* split Client/ClientHdr, HBH-ID correlation, Receive/Serve dispatcher ([c98e14c](https://github.com/bbsakura/xk6-diameter/commit/c98e14ccd73c67cd3a639a2c0b68a9f877b7861f))


### Bug Fixes

* address PR [#121](https://github.com/bbsakura/xk6-diameter/issues/121) Copilot review ([b845589](https://github.com/bbsakura/xk6-diameter/commit/b8455893677aa5ca12e5ee04f2b9497f0713e1d1))
...
* **deps:** update github.com/grafana/sobek digest to 74c003c ([#111](https://github.com/bbsakura/xk6-diameter/issues/111)) ([30b4c18](https://github.com/bbsakura/xk6-diameter/commit/30b4c18017c8e8fb25b8b2ec6cf83148df626299))
...
* **deps:** update module github.com/fiorix/go-diameter/v4 to v4.3.0 ([#118](https://github.com/bbsakura/xk6-diameter/issues/118)) ([8ea8d5a](https://github.com/bbsakura/xk6-diameter/commit/8ea8d5a7558d77c9fe19a9322c8174ad5b6d6798))
...
* **deps:** update module go.k6.io/k6 to v1.7.1 ([#119](https://github.com/bbsakura/xk6-diameter/issues/119)) ([1b5f592](https://github.com/bbsakura/xk6-diameter/commit/1b5f59286e4b125fc18dda4642ca309d78f02cd8))
